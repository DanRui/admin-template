...
import com.xiaohao.admin.template.velocity.OverrideDirective.OverrideNodeWrapper;
...
class Utils {
	...
	static String getRequiredArgument( InternalContextAdapter context, Node node, int argumentIndex, String directive )
		...
		if ( sn_value == null ) {
			throw new ParseErrorException("required argument is null with directive:#"
					+ directive + "(),argumentIndex=" + argumentIndex);
		}
